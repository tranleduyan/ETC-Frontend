...
function EquipmentInventoryCard(props) {
  ...
  return (
    <div
      className={`EquipmentInventoryCard-Container ${
        isSelected ? "EquipmentInventoryCard-Active" : ""
      } ${className}`}
    >
      <button
        className="EquipmentInventoryCard-ModelPhoto"
      ...
      <button
        className="EquipmentInventoryCard-InformationContainer"
        onClick={HandleOnClick}
      >
